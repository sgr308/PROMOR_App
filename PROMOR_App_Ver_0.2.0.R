                    ...
                    dashboardSidebar(width = 270,
                      ...
                      sidebarMenu(
                        ...
                        menuItem("Data Preprocessing:",tabName="upload", icon = icon("cogs"),
                                 ...
                                 numericInput("dp3","Remove proteins (rows) if they are identified by less than or equal to the following number of unique pepties:",min = 1, max = 20, value = 2),
                                                ...
                                                tabPanel(title = "Volcano Plot",
                                                         fluidRow(
                                                           ...
                                                           box(checkboxInput("rvp4","Label Protein IDs:", TRUE),
                                                               ...
                                                               numericInput("dVLPH","Height of the plot (px):",min = 1, max = 500000, value = 900),
                                                               numericInput("dVLPW","Width of the plot (px):",min = 1, max = 500000, value = 900), width = 6)),
